...
const PRICES = {
  'Initial Assessment':   10000, // £100 in pence
  'Standard Session':     7500,  // £75
  'Extended Session':     9000,  // £90
  'Starter Programme':    29500, // £295
  'Full Programme':       43500, // £435
  'Block of 4 Sessions':  28000, // £280
  'Block of 6 Sessions':  40000, // £400
};
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // 3. Hold the slot while payment is in progress
    if (bd.bookedDate && bd.bookedTime) {
      await supabase
