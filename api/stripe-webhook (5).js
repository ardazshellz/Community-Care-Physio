          ...
          await transporter.sendMail({
            ...
            html: `<div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto">
              ...
              <div style="background:#fff;padding:28px;border:1px solid #e8f2ee;border-top:none">
                <h2 style="color:#1e4d3b;font-size:18px;margin:0 0 16px">Booking confirmed! 🎉</h2>
                ...
                <p style="font-size:13px;color:#586860;line-height:1.6">
                  Your physiotherapist will arrive at your address at the confirmed time.
                  Please wear comfortable clothing and have any relevant letters or scan results ready.
                </p>
                <p style="font-size:13px;color:#586860;line-height:1.6">
                  You'll receive a reminder before your appointment. If you need to reschedule,
                  please give at least 24 hours notice to avoid the £50 cancellation fee.
                </p>
                <div style="margin-top:24px;padding-top:20px;border-top:1px solid #e8f2ee;font-size:12px;color:#586860">
                  <p>Questions? WhatsApp us on <strong>07508 401627</strong> or reply to this email.</p>
                  <p style="color:#8aab97;margin-top:8px">Community Care Physio · communitycarephysio.co.uk</p>
                </div>
              </div>
            </div>`
          });
