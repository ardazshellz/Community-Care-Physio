...
const QR_PUBLIC_URL = 'https://www.communitycarephysio.co.uk/review-qr.png';
...
07508 401627`;
  ...
  try {
    const qrResponse = await fetch(QR_PUBLIC_URL);
    if (qrResponse.ok) {
      qrAttachment = {
    ...
    console.warn('Review QR could not be attached:', error?.message || error);
  }
